...
IUSE="debugger nsight profiler vis-profiler sanitizer samples doc opencl fs"
...
src_install() {
	...
	local builddirs=(
		...
		$(usex profiler "builds/cuda_nvprof builds/cuda_cupti builds/cuda_profiler_api builds/cuda_sanitizer_api" "")
		$(usex vis-profiler "builds/cuda_nvvp" "")
		$(usex debugger "builds/cuda_gdb builds/libnvjitlink" "")
		$(usex doc "builds/cuda_documentation" "")
		$(usex samples "builds/cuda_demo_suite builds/libnvvm_samples" "")
		$(usex opencl "builds/cuda_opencl" "")
		$(usex fs "builds/nvidia_fs builds/libcufile" "")
	)
